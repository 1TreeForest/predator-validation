...
k,m){(function(d){function e(h,a,b,f){var e={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},y={mouseup:"pointerup",mousedown:"pointerdown",mousemove:"pointermove"},M={mouseup:"MSPointerUp",mousedown:"MSPointerDown",mousemove:"MSPointerMove"};if(d.navigator.pointerEnabled)B[a](h,y[b],f);else if(d.navigator.msPointerEnabled)B[a](h,M[b],f);else B[a](h,e[b],f),B[a](h,b,f)}function a(h){if(void 0!==h.touches)return h.touches.length;if(void 0!==h.which&&0!==h.which)return h.which;if(void 0!==
h.buttons)return h.buttons;h=h.button;if(void 0!==h)return h&1?1:h&2?3:h&4?2:0}function b(h,a){return"undefined"!==typeof d[a]?d[a]:y.clientHeight?y[h]:E.body[h]}function A(h,a,b){h=h||{};var f=h.className;h.className+=" gu-hide";a=E.elementFromPoint(a,b);h.className=f;return a}function x(){return!1}function K(){return!0}function v(a){return a.parentNode===E?null:a.parentNode}function D(a){return"INPUT"===a.tagName||"TEXTAREA"===a.tagName||"SELECT"===a.tagName||m(a)}function m(a){return a&&"false"!==
a.contentEditable?"true"===a.contentEditable?!0:m(v(a)):!1}function z(a){var b;if(!(b=a.nextElementSibling)){do a=a.nextSibling;while(a&&1!==a.nodeType);b=a}return b}function w(a,b){b=b.targetTouches&&b.targetTouches.length?b.targetTouches[0]:b.changedTouches&&b.changedTouches.length?b.changedTouches[0]:b;var f={pageX:"clientX",pageY:"clientY"};a in f&&!(a in b)&&f[a]in b&&(a=f[a]);return b[a]}var M=l("contra/emitter"),B=l("crossvent"),f=l("./classes"),E=document,y=E.documentElement;k.exports=function(d,
l){function h(c){return-1!==p.containers.indexOf(c)||g.isContainer(c)}function k(c){c=c?"remove":"add";e(y,c,"mousedown",ha);e(y,c,"mouseup",N)}function m(c){e(y,c?"remove":"add","mousemove",ia)}function F(c){c=c?"remove":"add";B[c](y,"selectstart",T);B[c](y,"click",T)}function T(c){G&&c.preventDefault()}function ha(c){U=c.clientX;V=c.clientY;if(1===a(c)&&!c.metaKey&&!c.ctrlKey){var n=c.target,b=O(n);b&&(G=b,m(),"mousedown"===c.type&&(D(n)?n.focus():c.preventDefault()))}}function ia(c){if(G)if(0===
a(c))N({});else if(void 0===c.clientX||c.clientX!==U||void 0===c.clientY||c.clientY!==V){if(g.ignoreInputTextSelection){var n=w("clientX",c);var H=w("clientY",c);n=E.elementFromPoint(n,H);if(D(n))return}n=G;m(!0);F();W();X(n);H=u.getBoundingClientRect();n=H.left+b("scrollLeft","pageXOffset");H=H.top+b("scrollTop","pageYOffset");Y=w("pageX",c)-n;Z=w("pageY",c)-H;f.add(r||u,"gu-transit");t||(n=u.getBoundingClientRect(),t=u.cloneNode(!0),t.style.width=(n.width||n.right-n.left)+"px",t.style.height=(n.height||
...
r||u,a=v(c);a&&a.removeChild(c);p.emit(r?"cancel":"remove",c,a,q);R()}}function da(c){if(p.dragging){var a=0<arguments.length?c:g.revertOnSpill,b=r||u,f=v(b),d=Q(f);!1===d&&a&&(r?f&&f.removeChild(r):q.insertBefore(b,J));d||a?p.emit("cancel",b,q,q):p.emit("drop",b,f,q,I);R()}}function R(){var c=r||u;G=!1;m(!0);F(!0);t&&(f.rm(g.mirrorContainer,"gu-unselectable"),e(y,"remove","mousemove",P),v(t).removeChild(t),t=null);c&&f.rm(c,"gu-transit");S&&clearTimeout(S);p.dragging=!1;C&&p.emit("out",c,C,q);p.emit("dragend",
c);q=u=r=J=I=S=C=null}function Q(c,a){a=void 0!==a?a:t?I:z(r||u);return c===q&&a===J}function ba(c,a,b){function f(){if(!1===h(n))return!1;var f=ea(n,c);f=fa(n,f,a,b);return Q(n,f)?!0:g.accepts(u,n,q,f)}for(var n=c;n&&!f();)n=v(n);return n}function P(a){if(t){a.preventDefault();var c=w("clientX",a);a=w("clientY",a);var b=a-Z;t.style.left=c-Y+"px";t.style.top=b+"px";b=r||u;var f=A(t,c,a),d=ba(f,c,a),h=null!==d&&d!==C;if(h||null===d)C&&p.emit("out",b,C,q),C=d,h&&p.emit("over",b,C,q);var e=v(b);if(d===
...
if(h&&e.left+e.width/2>f||!h&&e.top+e.height/2>d)return g}return null}function e(){var a=b.getBoundingClientRect();if(B){var c=d-a.top,g=f-a.left;a=Math.min(g,a.right-f,c,a.bottom-d);return g===a||c===a?z(b):b}return h?f>a.left+(a.width||a.right-a.left)/2?z(b):b:d>a.top+(a.height||a.bottom-a.top)/2?z(b):b}var h="horizontal"===g.direction,B="grid"===g.direction;return b!==a?e():c()}1===arguments.length&&!1===Array.isArray(d)&&(l=d,d=[]);var t,q,u,Y,Z,U,V,J,I,r,S,C=null,G,g=l||{};void 0===g.moves&&
(g.moves=K);void 0===g.accepts&&(g.accepts=K);void 0===g.invalid&&(g.invalid=ja);void 0===g.containers&&(g.containers=d||[]);void 0===g.isContainer&&(g.isContainer=x);void 0===g.copy&&(g.copy=!1);void 0===g.copySortSource&&(g.copySortSource=!1);void 0===g.revertOnSpill&&(g.revertOnSpill=!1);void 0===g.removeOnSpill&&(g.removeOnSpill=!1);void 0===g.direction&&(g.direction="vertical");void 0===g.ignoreInputTextSelection&&(g.ignoreInputTextSelection=!0);void 0===g.mirrorContainer&&(g.mirrorContainer=
E.body);var p=M({containers:g.containers,start:function(a){(a=O(a))&&X(a)},end:W,cancel:da,remove:ca,destroy:function(){k(!0);N({})},canMove:function(a){return!!O(a)},dragging:!1});if(!0===g.removeOnSpill)p.on("over",ka).on("out",la);k();return p}}).call(this,"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./classes":1,"contra/emitter":5,crossvent:6}],3:[function(l,k,m){k.exports=function(d,e){return Array.prototype.slice.call(d,e)}},{}],
4:[function(l,k,m){var d=l("ticky");k.exports=function(e,a,b){e&&d(function(){e.apply(b||null,a||[])})}},{ticky:9}],5:[function(l,k,m){var d=l("atoa"),e=l("./debounce");k.exports=function(a,b){var l=b||{},k={};void 0===a&&(a={});a.on=function(b,d){k[b]?k[b].push(d):k[b]=[d];return a};a.once=function(b,d){d._once=!0;a.on(b,d);return a};a.off=function(b,d){var e=arguments.length;if(1===e)delete k[b];else if(0===e)k={};else{e=k[b];if(!e)return a;e.splice(e.indexOf(d),1)}return a};a.emit=function(){var b=
d(arguments);return a.emitterSnapshot(b.shift()).apply(this,b)};a.emitterSnapshot=function(b){var m=(k[b]||[]).slice(0);return function(){var k=d(arguments),A=this||a;if("error"===b&&!1!==l.throws&&!m.length)throw 1===k.length?k[0]:k;m.forEach(function(d){l.async?e(d,k,A):d.apply(A,k);d._once&&a.off(b,d)});return a}};return a}},{"./debounce":4,atoa:3}],6:[function(l,k,m){(function(d){function e(a,b,d){return a.attachEvent("on"+b,m(a,b,d))}function a(a,b,d){if(d=x(a,b,d))return a.detachEvent("on"+
b,d)}function b(a,b,f){return function(b){var e=b||d.event;e.target=e.target||e.srcElement;e.preventDefault=e.preventDefault||function(){e.returnValue=!1};e.stopPropagation=e.stopPropagation||function(){e.cancelBubble=!0};e.which=e.which||e.keyCode;f.call(a,e)}}function m(a,d,e){var f=x(a,d,e)||b(a,d,e);w.push({wrapper:f,element:a,type:d,fn:e});return f}function x(a,b,d){a:{var e;for(e=0;e<w.length;e++){var f=w[e];if(f.element===a&&f.type===b&&f.fn===d){a=e;break a}}a=void 0}if(a)return b=w[a].wrapper,
w.splice(a,1),b}var K=l("custom-event"),v=l("./eventmap"),D=d.document,F=function(a,b,d,e){return a.addEventListener(b,d,e)},z=function(a,b,d,e){return a.removeEventListener(b,d,e)},w=[];d.addEventListener||(F=e,z=a);k.exports={add:F,remove:z,fabricate:function(a,b,d){if(-1===v.indexOf(b))d=new K(b,{detail:d});else{if(D.createEvent){var e=D.createEvent("Event");e.initEvent(b,!0,!0)}else D.createEventObject&&(e=D.createEventObject());d=e}a.dispatchEvent?a.dispatchEvent(d):a.fireEvent("on"+b,d)}}}).call(this,
"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./eventmap":7,"custom-event":8}],7:[function(l,k,m){l="undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{};m=[];var d="",e=/^on/;for(d in l)e.test(d)&&m.push(d.slice(2));k.exports=m},{}],8:[function(l,k,m){(function(d){var e=d.CustomEvent;k.exports=function(){try{var a=new e("cat",{detail:{foo:"bar"}});return"cat"===a.type&&"bar"===a.detail.foo}catch(b){}return!1}()?
e:"function"===typeof document.createEvent?function(a,b){var d=document.createEvent("CustomEvent");b?d.initCustomEvent(a,b.bubbles,b.cancelable,b.detail):d.initCustomEvent(a,!1,!1,void 0);return d}:function(a,b){var d=document.createEventObject();d.type=a;b?(d.bubbles=!!b.bubbles,d.cancelable=!!b.cancelable,d.detail=b.detail):(d.bubbles=!1,d.cancelable=!1,d.detail=void 0);return d}}).call(this,"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},
{}],9:[function(l,k,m){k.exports="function"===typeof setImmediate?function(d){setImmediate(d)}:function(d){setTimeout(d,0)}},{}]},{},[2])(2)});
