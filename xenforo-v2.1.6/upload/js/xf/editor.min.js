...
_init:function(a){e("#editor_spoiler_form").submit(XF.proxy(this,"submit"))},submit:function(a){a.preventDefault();a=this.ed;var b=this.overlay;a.selection.restore();XF.EditorHelpers.insertSpoiler(a,e("#editor_spoiler_title").val());b.hide()}});XF.EditorDialogCode=XF.extend(XF.EditorDialog,{_beforeShow:function(a){this.ed.$el.blur();a.$container.on("overlay:shown",function(){e(this).find(".CodeMirror")[0].CodeMirror.focus()})},_init:function(a){e("#editor_code_form").submit(XF.proxy(this,"submit"))},
submit:function(a){a.preventDefault();a=this.ed;var b=this.overlay,d=b.$container.find(".CodeMirror");if(d.length){d=d[0].CodeMirror;var c=d.getDoc();d.save();c.setValue("");d.setOption("mode","")}d=e("#editor_code_type");c=e("#editor_code_code");a.selection.restore();XF.EditorHelpers.insertCode(a,d.val(),c.val());b.hide();c.val("");d.val("")}});XF.editorStart={started:!1,custom:[],startAll:function(){XF.editorStart.started||(XF.editorStart.setupLanguage(),XF.editorStart.registerCommands(),XF.editorStart.registerCustomCommands(),
XF.editorStart.registerEditorDropdowns(),XF.editorStart.registerDialogs(),e(l).trigger("editor:first-start"),XF.editorStart.started=!0)},setupLanguage:function(){var a=e("html").attr("dir");try{var b=e.parseJSON(e(".js-editorLanguage").first().html())||{}}catch(d){console.error(d),b={}}e.FE.LANGUAGE.xf={translation:b,direction:a?a.toLowerCase():"ltr"}},registerCommands:function(){e.FE.DefineIcon("xfQuote",{NAME:"quote-right"});e.FE.RegisterCommand("xfQuote",{title:"Quote",icon:"xfQuote",undo:!0,focus:!0,
callback:function(){XF.EditorHelpers.wrapSelectionText(this,"[QUOTE]","[/QUOTE]",!0)}});e.FE.DefineIcon("xfCode",{NAME:"code"});e.FE.RegisterCommand("xfCode",{title:"Code",icon:"xfCode",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.loadDialog(this,"code")}});e.FE.DefineIcon("xfInlineCode",{NAME:"terminal"});e.FE.RegisterCommand("xfInlineCode",{title:"Inline Code",icon:"xfInlineCode",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.wrapSelectionText(this,"[ICODE]","[/ICODE]",!0)}});e.FE.DefineIcon("xfMedia",
{NAME:"video"});e.FE.RegisterCommand("xfMedia",{title:"Media",icon:"xfMedia",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.loadDialog(this,"media")}});e.FE.DefineIcon("xfSpoiler",{NAME:"flag"});e.FE.RegisterCommand("xfSpoiler",{title:"Spoiler",icon:"xfSpoiler",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.loadDialog(this,"spoiler")}});e.FE.DefineIcon("xfInlineSpoiler",{NAME:"flag-checkered"});e.FE.RegisterCommand("xfInlineSpoiler",{title:"Inline Spoiler",icon:"xfInlineSpoiler",undo:!0,
focus:!0,callback:function(){XF.EditorHelpers.wrapSelectionText(this,"[ISPOILER]","[/ISPOILER]",!0)}});e.FroalaEditor.PLUGINS.xfSmilie=function(a){function b(b){var c=e(b.currentTarget);b=c.html();if(!e(b).hasClass("smilie--lazyLoad")){XF.EditorHelpers.focus(a);a.html.insert(b);n();XF.EditorHelpers.blur(a);if(p){var d=p.find(".js-emojiInsertedRow");d.find(".js-emojiInsert").html(b);d.addClassTransitioned("is-active");clearTimeout(v);v=setTimeout(function(){d.removeClassTransitioned("is-active")},
1500)}clearTimeout(w);w=setTimeout(function(){XF.logRecentEmojiUsage(c.data("shortname"))},1500)}}function d(a,b){for(var c,d,f=0;f<a.length;f++)c=a[f],c.isIntersecting&&(d=e(c.target),g(d),b.unobserve(c.target))}function c(a){var b=a;a instanceof Event&&(b=e(a.currentTarget));if(b.is(":visible")){var c=b[0].getBoundingClientRect(),d=c.bottom+100;b.children().each(function(){var a=e(this),b=this.getBoundingClientRect();if(!(b.bottom<c.top)){if(b.top>d)return!1;a.find("span.smilie--lazyLoad").each(function(){var a=
e(this);this.getBoundingClientRect().top<=d&&g(a)})}})}}function g(a){var b=e("<img />").attr({"class":a.attr("class").replace(/(\s|^)smilie--lazyLoad(\s|$)/," "),alt:a.attr("data-alt"),title:a.attr("title"),src:a.attr("data-src"),"data-shortname":a.attr("data-shortname")}),c=function(){var c=function(){a.replaceWith(b)};k.requestAnimationFrame?k.requestAnimationFrame(c):c()};if(b.prop("complete"))c();else b.on("load",c)}function h(){var a=e(this),d=p.find(".js-emojiFullList"),f=p.find(".js-emojiSearchResults");
clearTimeout(x);x=setTimeout(function(){var e=a.val();if(!e||2>e.length)f.hide(),d.show(),c(d);else{var h=XF.canonicalizeUrl("index.php?editor/smilies-emoji/search");XF.ajax("GET",h,{q:e},function(a){a.html&&XF.setupHtmlInsert(a.html,function(a){a.find(".js-emoji").on("click",b);d.hide();f.replaceWith(a)})})}},300)}function f(){var a=XF.getRecentEmojiUsage(),d=q.find(".js-recentHeader"),f=q.find(".js-recentBlock"),h=f.find(".js-recentList"),g=q.find(".js-emojiList");if(a){var n=h.clone(),k=[];n.empty();
for(var l in a){var p=a[l],m;g.each(function(){m=e(this).find('.js-emoji[data-shortname="'+p+'"]').closest("li").clone();if(m.length)return m.find(".js-emoji").on("click",b),k.push(m),!1})}for(l in k)k[l].appendTo(n);h.replaceWith(n);f.hasClass("is-hidden")&&(f.hide(),f.removeClass("is-hidden"),d.removeClass("is-hidden"),f.xfFadeDown(XF.config.speed.fast));c(n)}}function n(){a.selection.save()}function r(){a.selection.restore()}var m=!1,t=!1,p,q,u=0,v,w,x;return{showMenu:function(){n();XF.EditorHelpers.blur(a);
var g=a.$tb.find('.fr-command[data-cmd="xfSmilie"]');if(!m){m=!0;p=e(e.parseHTML(Mustache.render(e(".js-xfSmilieMenu").first().html())));p.insertAfter(g);g.data("xf-click","menu");var y=XF.Event.getElementHandler(g,"menu","click");p.on("menu:complete",function(){q=p.find(".menu-scroller");if(!t){t=!0;if(k.IntersectionObserver){var g=new IntersectionObserver(d,{root:q[0],rootMargin:"0px 0px 100px 0px"});q.find("span.smilie--lazyLoad").each(function(){g.observe(this)})}else q.onPassive("scroll",c);
q.find(".js-emoji").on("click",b);var m=p.find(".js-emojiSearch");m.on("focus",n);m.on("blur",r);m.on("input",h);p.find(".js-emojiCloser").on("click",function(){XF.EditorHelpers.focus(a)});e(l).on("recent-emoji:logged",f);a.events.on("commands.mousedown",function(a){"xfSmilie"!=a.data("cmd")&&y.close()});p.on("menu:closed",function(){u=q.scrollTop()})}q.scrollTop(u);k.IntersectionObserver||c(q)});p.on("menu:closed",function(){setTimeout(function(){a.markers.remove()},50)})}(g=g.data("xfClickHandlers"))&&
g.menu&&g.menu.toggle()}}};e.FE.DefineIcon("xfSmilie",{NAME:"smile"});e.FE.RegisterCommand("xfSmilie",{title:"Smilies",icon:"xfSmilie",undo:!1,focus:!1,refreshOnCallback:!1,callback:function(){this.xfSmilie.showMenu()}});e.FE.DefineIcon("xfDraft",{NAME:"save"});e.FE.RegisterCommand("xfDraft",{type:"dropdown",title:"Drafts",focus:!0,undo:!1,options:{xfDraftSave:"Save Draft",xfDraftDelete:"Delete Draft"},callback:function(a,b){a=this.$el.closest("form");a.length?(a=XF.Element.getHandler(a,"draft"))?
"xfDraftSave"==b?a.triggerSave():"xfDraftDelete"==b&&a.triggerDelete():console.error("No draft handler on parent form"):console.error("No parent form to find draft handler")}});e.extend(e.FE.DEFAULTS,{xfBbCodeAttachmentContextInput:"attachment_hash_combined"});e.FE.PLUGINS.bbCode=function(a){function b(){return a.$tb.find(".fr-command[data-cmd=xfBbCode]")}function d(){var b=a.$oel,c=b.data("xfBbCodeBox");if(!c){var d=parseInt(a.$wp.css("border-bottom-width"),10)+parseInt(a.$wp.css("border-top-width"),
10);c=e('<textarea class="input" style="display: none" />');c.attr("aria-label",XF.htmlspecialchars(XF.phrase("rich_text_box")));c.css({minHeight:a.opts.heightMin?a.opts.heightMin+d+"px":null,maxHeight:a.opts.heightMax?a.opts.heightMax+"px":null,height:a.opts.height?a.opts.height+d+"px":null,padding:a.$el.css("padding")});c.attr("name",b.data("original-name"));b.data("xfBbCodeBox",c);a.$wp.after(c);XF.Element.applyHandler(c,"textarea-handler");XF.Element.applyHandler(c,"user-mentioner");XF.Element.applyHandler(c,
"emoji-completer")}return c}function c(c,e){var f=d(),g=function(c,d){h=!0;a.undo.saveStep();a.$el.blur();var e=b();a.$tb.find(" > .fr-command").not(e).addClass("fr-disabled");e.addClass("fr-active");a.$wp.css("display","none");a.$oel.prop("disabled",!0);f.val(c).css("display","").prop("disabled",!1).trigger("autosize");d||f.autofocus();XF.setIsEditorEnabled(!1)};"string"==typeof c?g(c,e):XF.ajax("POST",XF.canonicalizeUrl("index.php?editor/to-bb-code"),{html:a.html.get()},function(a){g(a.bbCode,e)})}
function g(c){var f=d(),g=function(c){h=!1;var d=b();a.$tb.find(" > .fr-command").not(d).removeClass("fr-disabled");d.removeClass("fr-active");a.$oel.prop("disabled",!1);a.html.set(c);f.css("display","none").prop("disabled",!0);a.$wp.css("display","");a.events.focus();a.undo.saveStep();a.size.refresh();XF.setIsEditorEnabled(!0);XF.layoutChange()};if("string"==typeof c)g(c);else{c={bb_code:f.val()};var k=a.$el.closest("form");k.length&&k[0][a.opts.xfBbCodeAttachmentContextInput]&&(c.attachment_hash_combined=
e(k[0][a.opts.xfBbCodeAttachmentContextInput]).val());XF.ajax("POST",XF.canonicalizeUrl("index.php?editor/to-html"),c,function(a){g(a.editorHtml)})}}var h=!1;return{_init:function(){a.events.on("buttons.refresh",function(){return!h})},toBbCode:c,isBbCodeView:function(){return h},getTextArea:function(){return h?d():null},insertBbCode:function(a){if(h){var b=d();XF.insertIntoTextBox(b,a)}},replaceBbCode:function(a){if(h){var b=d();XF.replaceIntoTextBox(b,a)}},toHtml:g,toggle:function(){h?g():c()}}};
e.FE.DefineIcon("xfBbCode",{NAME:"cog"});e.FE.RegisterCommand("xfBbCode",{title:"Toggle BB Code",icon:"xfBbCode",undo:!1,focus:!1,forcedRefresh:!0,callback:function(){this.bbCode.toggle()}})},registerCustomCommands:function(){try{var a=e.parseJSON(e(".js-editorCustom").first().html())||{}}catch(d){console.error(d),a={}}for(var b in a)a.hasOwnProperty(b)&&function(a,b){var c="xfCustom_"+a,d=a.toUpperCase();a={};"fa"==b.type?a=(a=b.value.match(/^fa([slrb]) fa-(.+)$/))?{FA5NAME:a[2],template:"font_awesome_5"+
("s"===a[1]?"":a[1])}:{NAME:b.value}:"image"==b.type&&(a={template:"image",SRC:'"'+XF.canonicalizeUrl(b.value)+'"',ALT:'"'+b.title+'"'});e.FE.DefineIcon(c,a);e.FE.RegisterCommand(c,{title:b.title,icon:c,undo:!0,focus:!0,callback:function(){XF.EditorHelpers.wrapSelectionText(this,"yes"==b.option?"["+d+"=]":"["+d+"]","[/"+d+"]",!0)}});XF.editorStart.custom.push(c)}(b,a[b])},registerEditorDropdowns:function(){try{var a=e.parseJSON(e(".js-editorDropdowns").first().html())||{}}catch(d){console.error("Editor dropdowns data not valid: ",
d),a={}}for(var b in a)a.hasOwnProperty(b)&&function(a,b){b.icon=b.icon.substr(3);e.FE.DefineIcon(a,{NAME:b.icon});e.FE.RegisterCommand(a,{type:"dropdown",title:b.title,icon:a,undo:!1,focus:!1,html:function(){var c='<ul class="fr-dropdown-list">',d=b.buttons,f,k;(f=XF.getEditorInContainer(this.$oel))&&f.buttonManager&&(d=f.buttonManager.getDropdown(a));for(var l in d)f=d[l],(k=e.FE.COMMANDS[f])&&(c+='<li><a class="fr-command" data-cmd="'+f+'">'+this.icon.create(k.icon||f)+"&nbsp;&nbsp;"+this.language.translate(k.title)+
"</a></li>");return c+"</ul>"}})}(b,a[b])},registerDialogs:function(){XF.EditorHelpers.dialogs.media=new XF.EditorDialogMedia("media");XF.EditorHelpers.dialogs.spoiler=new XF.EditorDialogSpoiler("spoiler");XF.EditorHelpers.dialogs.code=new XF.EditorDialogCode("code")}};e(l).one("editor:start",XF.editorStart.startAll);XF.EditorPlaceholderClick=XF.Event.newHandler({eventNameSpace:"XFEditorPlaceholderClick",options:{},edInitialized:!1,init:function(){},click:function(a){var b=this.$target,d=this;a=function(){d.edInitialized=
!0;b.find(".editorPlaceholder-editor").removeClass("is-hidden");b.find(".editorPlaceholder-placeholder").addClass("is-hidden")};var c=XF.getEditorInContainer(b);c instanceof XF.Editor?this.edInitialized||c.startInit({beforeInit:a,afterInit:function(a,b){b.events.focus(!0);XF.isIOS()&&(a.scrollToCursor(),a.scrollToCursorAfterPendingResize());b.opts.tooltips&&setTimeout(function(){b.tooltip.hide()},30)}}):(a(),c instanceof e&&c.focus())}});XF.Event.register("click","editor-placeholder","XF.EditorPlaceholderClick");
XF.Element.register("editor","XF.Editor")}(jQuery,window,document);
