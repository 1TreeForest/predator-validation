...
if("="==b&&a.eat(">"))return p("=>","operator");if("0"==b&&a.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/))return p("number","number");if(/\d/.test(b))return a.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/),p("number","number");if("/"==b){if(a.eat("*"))return c.tokenize=V,V(a,c);if(a.eat("/"))return a.skipToEnd(),p("comment","comment");if(qa(a,c,1)){a:for(var d=c=!1;null!=(b=a.next());){if(!c){if("/"==b&&!d)break a;"["==b?d=!0:d&&"]"==b&&(d=!1)}c=!c&&"\\"==b}a.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/);
return p("regexp","string-2")}a.eat("=");return p("operator","operator",a.current())}if("`"==b)return c.tokenize=fa,fa(a,c);if("#"==b)return a.skipToEnd(),p("error","error");if("<"==b&&a.match("!--")||"-"==b&&a.match("->"))return a.skipToEnd(),p("comment","comment");if(ra.test(b))return">"==b&&c.lexical&&">"==c.lexical.type||(a.eat("=")?"!"!=b&&"="!=b||a.eat("="):/[<>*+\-]/.test(b)&&(a.eat(b),">"==b&&a.eat(b))),p("operator","operator",a.current());if(ha.test(b)){a.eatWhile(ha);b=a.current();if("."!=
c.lastType){if(sa.propertyIsEnumerable(b))return a=sa[b],p(a.type,a.style,b);if("async"==b&&a.match(/^(\s|\/\*.*?\*\/)*[\[\(\w]/,!1))return p("async","keyword",b)}return p("variable","variable",b)}}function Ka(a){return function(c,b){var d=!1,u;if(W&&"@"==c.peek()&&c.match(La))return b.tokenize=D,p("jsonld-keyword","meta");for(;null!=(u=c.next())&&(u!=a||d);)d=!d&&"\\"==u;d||(b.tokenize=D);return p("string","string")}}function V(a,c){for(var b=!1,d;d=a.next();){if("/"==d&&b){c.tokenize=D;break}b=
"*"==d}return p("comment","comment")}function fa(a,c){for(var b=!1,d;null!=(d=a.next());){if(!b&&("`"==d||"$"==d&&a.eat("{"))){c.tokenize=D;break}b=!b&&"\\"==d}return p("quasi","string-2",a.current())}function ja(a,c){c.fatArrowAt&&(c.fatArrowAt=null);var b=a.string.indexOf("=>",a.start);if(!(0>b)){if(m){var d=/:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(a.string.slice(a.start,b));d&&(b=d.index)}d=0;var g=!1;for(--b;0<=b;--b){var e=a.string.charAt(b),f="([{}])".indexOf(e);if(0<=f&&3>f){if(!d){++b;
break}if(0==--d){"("==e&&(g=!0);break}}else if(3<=f&&6>f)++d;else if(ha.test(e))g=!0;else if(/["'\/`]/.test(e))for(;;--b){if(0==b)return;if(a.string.charAt(b-1)==e&&"\\"!=a.string.charAt(b-2)){b--;break}}else if(g&&!d){++b;break}}g&&!d&&(c.fatArrowAt=b)}}function ta(a,c,b,d,g,e){this.indented=a;this.column=c;this.type=b;this.prev=g;this.info=e;null!=d&&(this.align=d)}function f(){for(var a=arguments.length-1;0<=a;a--)d.cc.push(arguments[a])}function b(){f.apply(null,arguments);return!0}function ka(a,
c){for(;c;c=c.next)if(c.name==a)return!0;return!1}function H(a){var c=d.state;d.marked="def";if(c.context)if("var"==c.lexical.info&&c.context&&c.context.block){var b=ua(a,c.context);if(null!=b){c.context=b;return}}else if(!ka(a,c.localVars)){c.localVars=new Q(a,c.localVars);return}w.globalVars&&!ka(a,c.globalVars)&&(c.globalVars=new Q(a,c.globalVars))}function ua(a,c){return c?c.block?(a=ua(a,c.prev))?a==c.prev?c:new R(a,c.vars,!0):null:ka(a,c.vars)?c:new R(c.prev,new Q(a,c.vars),!1):null}function X(a){return"public"==
a||"private"==a||"protected"==a||"abstract"==a||"readonly"==a}function R(a,c,b){this.prev=a;this.vars=c;this.block=b}function Q(a,c){this.name=a;this.next=c}function I(){d.state.context=new R(d.state.context,d.state.localVars,!1);d.state.localVars=Ma}function va(){d.state.context=new R(d.state.context,d.state.localVars,!0);d.state.localVars=null}function z(){d.state.localVars=d.state.context.vars;d.state.context=d.state.context.prev}function e(a,c){var b=function(){var b=d.state,g=b.indented;if("stat"==
b.lexical.type)g=b.lexical.indented;else for(var e=b.lexical;e&&")"==e.type&&e.align;e=e.prev)g=e.indented;b.lexical=new ta(g,d.stream.column(),a,null,b.lexical,c)};b.lex=!0;return b}function g(){var a=d.state;a.lexical.prev&&(")"==a.lexical.type&&(a.indented=a.lexical.indented),a.lexical=a.lexical.prev)}function h(a){function c(d){return d==a?b():";"==a||"}"==d||")"==d||"]"==d?f():b(c)}return c}function q(a,c){return"var"==a?b(e("vardef",c),la,h(";"),g):"keyword a"==a?b(e("form"),ma,q,g):"keyword b"==
a?b(e("form"),q,g):"keyword d"==a?d.stream.match(/^\s*$/,!1)?b():b(e("stat"),na,h(";"),g):"debugger"==a?b(h(";")):"{"==a?b(e("}"),va,Y,g,z):";"==a?b():"if"==a?("else"==d.state.lexical.info&&d.state.cc[d.state.cc.length-1]==g&&d.state.cc.pop()(),b(e("form"),ma,q,g,wa)):"function"==a?b(x):"for"==a?b(e("form"),xa,q,g):"class"==a||m&&"interface"==c?(d.marked="keyword",b(e("form","class"==a?a:c),ya,g)):"variable"==a?m&&"declare"==c?(d.marked="keyword",b(q)):m&&("module"==c||"enum"==c||"type"==c)&&d.stream.match(/^\s*\w/,
!1)?(d.marked="keyword","enum"==c?b(za):"type"==c?b(Aa,h("operator"),n,h(";")):b(e("form"),y,h("{"),e("}"),Y,g,g)):m&&"namespace"==c?(d.marked="keyword",b(e("form"),l,q,g)):m&&"abstract"==c?(d.marked="keyword",b(q)):b(e("stat"),Na):"switch"==a?b(e("form"),ma,h("{"),e("}","switch"),va,Y,g,g,z):"case"==a?b(l,h(":")):"default"==a?b(h(":")):"catch"==a?b(e("form"),I,Oa,q,g,z):"export"==a?b(e("stat"),Pa,g):"import"==a?b(e("stat"),Qa,g):"async"==a?b(q):"@"==c?b(l,q):f(e("stat"),l,h(";"),g)}function Oa(a){if("("==
a)return b(E,h(")"))}function l(a,c){return Ba(a,c,!1)}function v(a,c){return Ba(a,c,!0)}function ma(a){return"("!=a?f():b(e(")"),l,h(")"),g)}function Ba(a,c,u){if(d.state.fatArrowAt==d.stream.start){var k=u?Ca:Da;if("("==a)return b(I,e(")"),r(E,")"),g,h("=>"),k,z);if("variable"==a)return f(I,y,h("=>"),k,z)}k=u?J:K;return Ra.hasOwnProperty(a)?b(k):"function"==a?b(x,k):"class"==a||m&&"interface"==c?(d.marked="keyword",b(e("form"),Sa,g)):"keyword c"==a||"async"==a?b(u?v:l):"("==a?b(e(")"),na,h(")"),
g,k):"operator"==a||"spread"==a?b(u?v:l):"["==a?b(e("]"),Ta,g,k):"{"==a?S(Z,"}",null,k):"quasi"==a?f(aa,k):"new"==a?b(Ua(u)):"import"==a?b(l):b()}function na(a){return a.match(/[;\}\)\],]/)?f():f(l)}function K(a,c){return","==a?b(l):J(a,c,!1)}function J(a,c,u){var k=0==u?K:J,ia=0==u?l:v;if("=>"==a)return b(I,u?Ca:Da,z);if("operator"==a)return/\+\+|--/.test(c)||m&&"!"==c?b(k):m&&"<"==c&&d.stream.match(/^([^>]|<.*?>)*>\s*\(/,!1)?b(e(">"),r(n,">"),g,k):"?"==c?b(l,h(":"),ia):b(ia);if("quasi"==a)return f(aa,
k);if(";"!=a){if("("==a)return S(v,")","call",k);if("."==a)return b(Va,k);if("["==a)return b(e("]"),na,h("]"),g,k);if(m&&"as"==c)return d.marked="keyword",b(n,k);if("regexp"==a)return d.state.lastType=d.marked="operator",d.stream.backUp(d.stream.pos-d.stream.start-1),b(ia)}}function aa(a,c){return"quasi"!=a?f():"${"!=c.slice(c.length-2)?b(aa):b(l,Wa)}function Wa(a){if("}"==a)return d.marked="string-2",d.state.tokenize=fa,b(aa)}function Da(a){ja(d.stream,d.state);return f("{"==a?q:l)}function Ca(a){ja(d.stream,
...
"quasi"==c.lastType&&/\{\s*$/.test(a.string.slice(0,a.pos-(b||0)))}var O=Ja.indentUnit,Ia=w.statementIndent,W=w.jsonld,G=w.json||W,m=w.typescript,ha=w.wordCharacters||/[\w$\xa1-\uffff]/,sa=function(){function a(a){return{type:a,style:"keyword"}}var b=a("keyword a"),d=a("keyword b"),e=a("keyword c"),g=a("keyword d"),f=a("operator"),h={type:"atom",style:"atom"};return{"if":a("if"),"while":b,"with":b,"else":d,"do":d,"try":d,"finally":d,"return":g,"break":g,"continue":g,"new":a("new"),"delete":e,"void":e,
"throw":e,"debugger":a("debugger"),"var":a("var"),"const":a("var"),let:a("var"),"function":a("function"),"catch":a("catch"),"for":a("for"),"switch":a("switch"),"case":a("case"),"default":a("default"),"in":f,"typeof":f,"instanceof":f,"true":h,"false":h,"null":h,undefined:h,NaN:h,Infinity:h,"this":a("this"),"class":a("class"),"super":a("atom"),yield:e,"export":a("export"),"import":a("import"),"extends":e,await:e}}(),ra=/[+\-*&%=<>!?|~^@]/,La=/^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/,
